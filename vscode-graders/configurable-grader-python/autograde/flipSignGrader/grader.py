...
if feedback is None:
    numTestCases = 5
    testCases = [random.randint(-10,10) for i in range(0,numTestCases)]
    solutions = [flipSign(x) for x in testCases]
    learner_result = [flipSign_learn(x) for x in testCases]
